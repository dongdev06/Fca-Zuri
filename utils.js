...
function getGenderByPhysicalMethod(name) {
    var GirlName = ["NIMRA", "ISHA", "ALIYA", "HOORAIN", "ALIZEY", "SABA", "MEERAB", "HEER", "PRIYA", "POOJA", "ARTI", "SUMAN", "MEHAK", "UMRA", "NEHA", "RQZAX"];

    var BoyName = ["ANUP", "ANKIT", "ROSHAN", "SAQIB", "PRASHANT", "YOGESH", "NILESH", "MANISH", "ATUL", "KUNDAN", "ANUJ"];
...
function getAppState(jar, Encode) {
    ...
    var data;
        switch (require("../../FcaSetting.json").EncryptFeature) {
            case true: {
            ...
            case false: {
                ...
                break;
            default: {
                logger.Normal(getText(Language.IsNotABoolean,require("../../FcaSetting.json").EncryptFeature));
                data = appstate;
            } 
        }
            if(!globalThis.Fca.Setting.get('getAppState')) {
